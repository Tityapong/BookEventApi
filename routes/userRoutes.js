...
// router.get("/me", authorize(["User"]), getMe); // Only users with role 'User' can view their profile

// // Admin Role Management
// router.post("/change-role", authorize(["Admin"]), changeRole); // Change user role
// // Admin: Get all users
// router.get('/users', authorize(['admin']), getAllUsers); // Only admins can access this
